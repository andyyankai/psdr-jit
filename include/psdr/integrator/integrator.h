...
public:
    ...
    SpectrumD renderD_interior(const Scene &scene, int sensor_id = 0) const;
    SpectrumD renderD_primary(const Scene &scene, int sensor_id = 0) const;
    SpectrumD renderD_secondary(const Scene &scene, int sensor_id = 0) const;
